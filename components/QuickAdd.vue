    ...
    <Dialog as="div" class="relative z-10" @close="[$emit('openClose', false), reloadNuxtApp({ ttl: 100 })]">
      ...
      <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          ...
          >
            <DialogPanel
              class="relative max-h-fit max-w-6xl transform overflow-hidden rounded-lg bg-gray-200 px-4 pb-4 pt-5 text-left shadow-xl transition-all dark:bg-gray-800 sm:my-8 sm:w-full sm:p-6"
            >
              <div class="">
                <div class="sm:flex sm:items-center">
                  <div class="sm:flex-auto">
                    <h1 class="text-lg font-light leading-6 text-gray-800 dark:text-white">Quick Add:</h1>
                  </div>
                    ...
                    <Disclosure v-slot="{ open }">
                      ...
                      >
                        ...
                        <div>
                          ...
                          <button
                            @click.stop="store.deleteSystem(system.id)"
                            type="button"
                      ...
                      >
                        <div class="pr-4 sm:col-span-2">
                          ...
                          <div class="mt-2">
                            <input
                              v-model="store.SystemStigData[index].Name"
                              type="text"
                              name="system"
                        ...
                        <div class="ml-6 w-96 sm:col-span-2">
                          ...
                          >
                            <li
                              v-for="stig in store.SystemStigData[index].TempStigList"
                              :key="stig.StigId"
      ...
      try {
        for (let index = 0; index < store.SystemStigData[i].TempStigList.length; index++) {
          await useFetch("/api/systems/stig/add", {
            method: "POST",
            body: {
              StigId: store.SystemStigData[i].TempStigList[index].StigId,
              SystemId: systemId,
