                ...
                <table class="min-w-full divide-y divide-gray-700">
                  <thead>
                    <tr>
                      ...
                      <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-black dark:text-white">
                        Role
                      </th>
                      <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-black dark:text-white">
                        Email
                    ...
                    <tr v-for="(person, index) in data" :key="person.id">
                      ...
                      <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                        ...
                        <Menu as="div" class="relative ml-auto">
                          <MenuButton class="-m-2.5 block p-2.5 text-gray-800 hover:text-gray-500 dark:text-gray-100">
                                    ...
                                    <div class="h-0 flex-1 overflow-y-auto">
                                      <div class="bg-indigo-700 px-4 py-6 sm:px-6">
                                        ...
                                        <div class="mt-1">
                                          ...
                                          <p v-else class="text-sm text-indigo-300">Edit your users and roles</p>
                                        </div>
                                      </div>
                                        ...
                                        <div class="divide-y divide-gray-200 px-4 sm:px-6">
                                          <div class="space-y-6 pb-5 pt-6">
                                            <div>
                                              ...
                                              <div
                                                v-if="
                                                  edit === true && newReset && newConfirm && newReset !== newConfirm
                                                "
