<template>
  <div class="mx-auto max-w-7xl px-4 pb-0 sm:px-6 lg:px-0">
    <div class="bg-white dark:bg-gray-800 py-4 rounded-lg shadow-lg">
          ...
          <div class="mx-auto max-w-7xl pt-0 lg:flex lg:gap-x-8 lg:px-0">
            ...
            <div class="bg-white dark:bg-gray-800">
              <div class="mx-auto max-w-7xl">
                <div class="bg-gray-100 dark:bg-gray-900 pt-10 mt-6">
                  <div class="px-4 sm:px-6 lg:px-8">
                    <div class="sm:flex sm:items-center">
                      <div class="sm:flex-auto">
                        <h1 class="text-base font-semibold leading-6 text-black dark:text-white">Users</h1>
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-300">A list of all the users in your account
                          including their
                          name, title, email and role.</p>
                      </div>
                      <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                        <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                          <button type="button" @click="[open = true, edit = false]"
                            ...
                            <thead>
                              <tr>
                                <th scope="col"
                                  ...
                                  Name</th>
                                <th scope="col"
                                  class="px-3 py-3.5 text-left text-sm font-semibold text-black dark:text-white">Role</th>
                                <th scope="col"
                                  class="px-3 py-3.5 text-left text-sm font-semibold text-black dark:text-white">Email
                                </th>
                            ...
                            <tbody class="divide-y divide-gray-800">
                              <tr v-for="(person, index) in data" :key="person.id">
                                ...
                                <td
                                  ...
                                  {{
                                    person.firstName }} {{ person.lastName }}</td>
                                ...
                                <td
                                  ...
                                  <Menu as="div" class="relative ml-auto">
                                    <MenuButton
                                      class="-m-2.5 block p-2.5 text-gray-800 dark:text-gray-100 hover:text-gray-500">
                                    ...
                                    <transition enter-active-class="transition ease-out duration-100"
                                      ...
                                      <MenuItems
                                        ...
                                        <a @click="[edit = true, open = true, editId = person.id, newFirstName = person.firstName, newLastName = person.lastName, newEmail = person.email, newRoleId = person.UserRoleId, editTimezoneName = timeZones.at(person.TimezoneId - 1), newRoleName = person.UserRole.name, selected = person.UserRole]"
                                          :class="[active ? 'bg-gray-200 dark:bg-gray-700' : '', 'block px-3 py-1 text-sm leading-6 text-gray-800 dark:text-gray-100']">Edit<span
                                            class="sr-only">, </span></a>
                                        </MenuItem>
                                        <MenuItem v-slot="{ active }">
                                        <a href="#"
                                          @click="[openAlert = true, currentId = person.id, FN = person.firstName, LN = person.lastName]"
                                          :class="[active ? 'bg-gray-200 dark:bg-gray-700' : '', 'block px-3 py-1 text-sm leading-6 text-gray-800 dark:text-gray-100']">Delete<span
                                            class="sr-only">, </span></a>
                                        </MenuItem>
                                      </MenuItems>
                                    </transition>
                                      ...
                                      <div class="fixed inset-0 z-10 overflow-y-auto">
                                        <div
                                          ...
                                          <TransitionChild as="template" enter="ease-out duration-300"
                                            ...
                                            <DialogPanel
                                              class="relative transform overflow-hidden rounded-lg bg-gray-100 dark:bg-gray-800 px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                                              <div class="sm:flex sm:items-start">
                                                <div
                                                  class="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-gray-100 dark:bg-gray-800 border-2 border-red-600 sm:mx-0 sm:h-10 sm:w-10">
                                                ...
                                                <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                                  ...
                                                  <div class="mt-2">
                                                    <p class="text-sm text-gray-600 dark:text-gray-300">Are you sure you
                                                      want to delete this
                                                      User? All of your data will be permanently removed from our servers
                                              ...
                                              <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                                <button type="button"
                                                  ...
                                                  @click="[openAlert = false, deleteUser(currentId)]">Delete</button>
                                                <button type="button"
                                                  class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto"
                                                  @click="openAlert = false" ref="cancelButtonRef">Cancel</button>
                                              </div>
                                            </DialogPanel>
                                          </TransitionChild>
                                        </div>
                                      ...
                                      <div
                                        ...
                                        <TransitionChild as="template"
                                          ...
                                          <DialogPanel class="pointer-events-auto w-screen max-w-xs">
                                            <form @submit.prevent="edit ? editUser(editData) : addUser(UserData)"
                                              class="flex h-full flex-col divide-y divide-gray-200 bg-white dark:bg-gray-800 shadow-xl">
                                              <div class="h-0 flex-1 overflow-y-auto">
                                                <div class="bg-indigo-700 px-4 py-6 sm:px-6">
                                                  <div class="flex items-center justify-between">
                                                    <DialogTitle v-if="edit === true"
                                                      class="text-base font-semibold leading-6 text-white">Edit User
                                                    </DialogTitle>
                                                    <DialogTitle v-else
                                                      class="text-base font-semibold leading-6 text-white">Add User
                                                    </DialogTitle>
                                                  ...
                                                  <div class="mt-1">
                                                    <p class="text-sm text-indigo-300">Add your users and give them roles
                                                    </p>
                                                  </div>
                                                </div>
                                                    ...
                                                    <div class="space-y-6 pb-5 pt-6">
                                                      <div>
                                                        <label for="project-name"
                                                          class="block text-sm font-medium leading-6 text-gray-800 dark:text-white">First
                                                          Name
                                                        </label>
                                                        <div class="mt-2">
                                                          <input v-if="edit === true" required type="text"
                                                            name="project-name" id="project-name" v-model="newFirstName"
                                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                                          <input v-else v-model="FirstName" required type="text"
                                                            name="project-name" id="project-name"
                                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                                        </div>
                                                        <br>
                                                        <label for="project-name"
                                                          class="block text-sm font-medium leading-6 text-gray-800 dark:text-white">Last
                                                          Name
                                                        </label>
                                                        <div class="mt-2">
                                                          <input v-if="edit === true" required type="text"
                                                            name="project-name" id="project-name" v-model="newLastName"
                                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                                          <input v-else v-model="LastName" required type="text"
                                                            name="project-name" id="project-name"
                                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                                        </div>
                                                        <br>
                                                        <label for="project-name"
                                                          class="block text-sm font-medium leading-6 text-gray-800 dark:text-white">Email
                                                        </label>
                                                        <div class="mt-2">
                                                          <input v-if="edit === true" required type="text"
                                                            name="project-name" id="project-name" v-model="newEmail"
                                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                                          <input v-else v-model="Email" required type="text"
                                                            name="project-name" id="project-name"
                                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                                        </div>
                                                        <br v-if="edit != true">
                                                        <label v-if="edit != true" for="project-name"
                                                          class="block text-sm font-medium leading-6 text-gray-800 dark:text-white">Set
                                                          Password
                                                        </label>
                                                        <div class="mt-2">
                                                          <input v-if="edit != true" required type="text"
                                                            name="project-name" id="project-name" v-model="newPassword"
                                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                                        </div>
                                                        <!-----------------------------------------UserTimeZone---------------------------------------------------------->
                                                        <br>
                                                        <label for="project-name"
                                                          class="block text-sm font-medium leading-6 text-gray-800 dark:text-white">TimeZone
                                                        </label>
                                                        <select v-if="edit === true"
                                                          @click="console.log(editTimezoneName);"
                                                          v-model="editTimezoneName" id="timezone" name="timezone"
                                                          class="mt-2 block w-full rounded-md border-0 bg-white/5 text-gray-800 dark:text-white shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6 [&_*]:text-black">
                                                          <option v-for="time in timeZones">
                                                            {{ time }}
                                                          </option>
                                                        </select>
                                                        <select v-else @click="console.log(TimezoneName)"
                                                          v-model="TimezoneName" id="timezone" name="timezone"
                                                          class="mt-2 block w-full rounded-md border-0 bg-white/5 text-gray-800 dark:text-white shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6 [&_*]:text-black">
                                                          <option v-for="time in timeZones">
                                                            {{ time }}
                                                          </option>
                                                        ...
                                                        <!-----------------------------------------UserRoles---------------------------------------------------------->
                                                        <br>
                                                        <Listbox v-if="edit === true" class="sm:flex sm:justify-end"
                                                          as="div" v-model="selected">
                                                          ...
                                                          <div class="relative">
                                                            ...
                                                            <transition
                                                              ...
                                                              <ListboxOptions
                                                                ...
                                                                <ListboxOption as="template" v-for="option in roles"
                                                        ...
                                                        <Listbox v-else class="sm:flex sm:justify-end" as="div"
                                                          v-model="selected">
                                                          <ListboxLabel class="sr-only">Change published status
                                                          </ListboxLabel>
                                                          <div class="relative">
                                                        ...
                                                        <br v-if="edit === true">
                                                        <label v-if="edit === true" for="project-name"
                                                          class="block text-sm font-medium leading-6 text-gray-800 dark:text-white">New
                                                          Password
                                                        </label>
                                                        <div class="mt-2">
                                                          <input v-if="edit === true" name="project-name"
                                                            id="project-name" v-model="newReset"
                                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                                        </div>
                                                        <br v-if="edit === true">
                                                        <label v-if="edit === true" for="project-name"
                                                          class="block text-sm font-medium leading-6 text-gray-800 dark:text-white">Confirm
                                                          Password
                                                        </label>
                                                        <div class="mt-2">
                                                          <input v-if="edit === true" name="project-name"
                                                            id="project-name" v-model="newConfirm"
                                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                                        </div>
                                                        <br>
                                                        <div
                                                          v-if="edit === true && newReset && newConfirm && newReset !== newConfirm"
                                              ...
                                              <div class="flex flex-shrink-0 justify-end px-4 py-4">
                                                ...
                                                <button v-if="edit != true" type="submit"
...
async function addUser(UserData) {
  try {
    ...
    try {
      // console.log('Setting PW', newPassword)
...
// async function addRoles(UserRoles)
// {
// try{
//   console.log(UserData);
//   await useFetch("/api/users/roles", {
//       method: 'POST',
//       body: UserData
//   } );}
// finally{
...
async function editUser(editData) {
  console.log("editUser function was called :");
  try {
    await useFetch("/api/users/edit", {
      method: 'PUT',
      body: editData
    ...
    console.error("exception in editUser function:", error);
  } finally {
