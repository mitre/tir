...
// With foreign keys on, DROP TABLE deletes the rows first, which cascades into
// StigLibrary_Stigs and trips the Boundaries RESTRICT.
const withForeignKeysOff = async (sequelize, rebuild) => {
...
export const up = async ({ context: sequelize }) => {
  if (sequelize.getDialect() === "sqlite") {
    await withForeignKeysOff(sequelize, async () => {
