              ...
              <ul role="list" class="flex gap-x-3 gap-y-1 whitespace-nowrap lg:flex-col">
                <li v-for="(item, index) in secondaryNavigation" :key="item.name">
                  ...
                  >
                    ...
                    <div
                      v-if="index === 2"
                      class="right-10 top-12 inline-flex items-center rounded-md bg-gray-400/10 px-1 text-xs font-medium text-gray-400 ring-1 ring-inset ring-gray-400/20"
                    >
                      PHASE 3
                    </div>
                  </a>
          ...
          <main class="px-4 py-16 sm:px-6 lg:flex-auto lg:px-0 lg:py-20">
            <div class="mx-auto max-w-2xl space-y-16 sm:space-y-20 lg:mx-0 lg:max-w-none">
              <div>
                ...
                <p class="mt-1 text-sm leading-6 text-gray-500 dark:text-gray-200">
                ...
                <dl class="mt-6 space-y-6 divide-y divide-gray-100 border-t border-gray-200 text-sm leading-6">
                  ...
                  <SwitchGroup as="div" class="flex pt-6">
                    <SwitchLabel
                      as="dt"
                      class="flex-none pr-6 font-medium text-gray-800 dark:text-white sm:w-64"
                      passive
                    >
                      Automatic timezone
                    </SwitchLabel>
...
import { BellIcon, WrenchIcon, UserCircleIcon, UsersIcon, DocumentDuplicateIcon } from "@heroicons/vue/24/outline";
