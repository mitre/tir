...
function getBoolValue(config: TirConfig[], valName: string): boolean | undefined {
  return configUtil.getBool(config, valName, logConfigPrefix);
}
function getStringValue(config: TirConfig[], valName: string): string | undefined {
  return configUtil.getStr(config, valName, logConfigPrefix);
}
function getNumValue(config: TirConfig[], valName: string): number | undefined {
  return configUtil.getNum(config, valName, logConfigPrefix);
}
